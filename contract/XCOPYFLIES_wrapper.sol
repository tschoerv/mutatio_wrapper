...
contract XCOPYFLIES_wrapper is ERC20, IERC1155Receiver, ReentrancyGuard, Ownable{
    ...
    function onERC1155BatchReceived(
        ...
        revert("Batch transfer not supported");     // In case XCOPY adds more tokens to this collection one day
    }

    function unwrap(uint256 erc20Amount) public nonReentrant {
